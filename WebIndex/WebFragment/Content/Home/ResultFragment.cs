...
namespace WebIndex.WebFragment.Content.Home
{
    ...
    public sealed class ResultFragment : FragmentControlPanelFlexbox
    {
        ...
        private void OnRetrieveVirtualItem(object sender, RetrieveVirtualListItemEventArgs e)
        {
            ...
            Counter.Text = I18N.Translate(e.RenderContext, "webindex:homepage.conter", res.Count());
            e.Items = res.Select
            (
        ...
        public override IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree)
        {
            ...
            Counter.Text = I18N.Translate(renderContext, "webindex:homepage.conter", res.Count());
